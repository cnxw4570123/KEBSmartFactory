...
// spring serve
// your server address
String springServerAddress = "http://172.30.1.88:8080";
...
void setup(void)
{
  ...
  server.on("/ControlAC", controlAirconditoner); // airconditionalController
  server.begin();
...
void calcTempCelsius()
{
  ...
  Tc = T - 273.15 + current_aircon; // celsius
}
...
void controlAirconditoner()
{
  Serial.println("AC On/Off REQ");
